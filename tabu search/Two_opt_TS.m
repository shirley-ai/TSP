function [BestCost, BestTSP ] = Two_opt_TS(Location,Nb_Nodes,TSP,TSPCost,TSPSize,Dis,PlotTour,TSPType)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The structure of this method£º
% 1)Initialize everything
% 2)perform constrained steepest CLS, which means choose the best solution
% from non tabu space
% 3)update tabu list based on our new solution
% 4)stop
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
